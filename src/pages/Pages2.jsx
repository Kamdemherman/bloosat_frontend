    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <div className="w-12 h-12 bg-blue-500 rounded-2xl flex items-center justify-center text-white font-bold text-xl mx-auto mb-4">B</div>
          <h1 className="text-xl font-semibold text-white">BLOOSAT BSS</h1>
          <p className="text-sm text-slate-400 mt-1">Business Support System</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-slate-800 rounded-2xl p-6 space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-slate-700 text-white text-sm rounded-lg px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-blue-500/40 placeholder-slate-500 border border-slate-600"
